...
var graphs = {};
customItems_1.registerCardNode();
var defaultLayout = {
    type: 'compactBox',
    direction: 'LR',
    getId: function (d) {
...
var IndentedTreeGraph = function (props) {
    ...
    react_1.useEffect(function () {
        ...
        graph.edge(function (edge) {
            ...
            return {
                style: __assign(__assign({ stroke: '#ccc' }, (showArrow && utils_2.getDefaultEdgeArrowCfg(0, arrowType))), edgeStyle),
            };
        });
        if (collapseExpand) {
            utils_2.bindDefaultEvents(graph, collapseExpand);
        }
        utils_2.renderGraph(graph, data, autoFit);
        if (onReady) {
            onReady(graph);
        }
        return function () {
