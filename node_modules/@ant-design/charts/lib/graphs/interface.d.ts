import { StateStyles, ShapeStyle, IGraph, ModelConfig, IG6GraphEvent, IGroup, LabelStyle, Node, Edge, EdgeConfig, NodeConfig, Graph, INode, IEdge, ArrowConfig as G6ArrowConfig } from '@antv/g6';
...
export declare type ShapeCfg = EdgeConfig | NodeConfig;
...
export declare type IArrowConfig = false | ArrowConfig | ((edge: Shape | ShapeCfg) => ArrowConfig);
...
export interface FlowAnalysisGraphNodeData extends NodeData<Array<{
    title?: string;
    items?: CardItems[];
}>> {
}
...
export interface OrganizationGraphData extends NodeData<Array<{
    name: string;
    title?: string;
    icon?: string;
}>> {
}
export declare type Datum = TreeGraphData | FlowAnalysisGraphDatum | OrganizationGraphData;
...
export declare type GraphConfig = FlowAnalysisGraphConfig & IndentedTreeGraphConfig & OrganizationGraphConfig & RadialTreeGraphConfig;
export { StateStyles, ShapeStyle, Node, Edge, IGraph, ModelConfig, IG6GraphEvent, IGroup, LabelStyle, EdgeConfig, NodeConfig, INode, IEdge, Graph, };
